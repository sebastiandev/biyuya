...
class DataDocument(JSONDocument):
    ...
    def __init__(self, data=None, included=None, meta=None):
        super(DataDocument, self).__init__(included, meta)
    ...
    def data(self):
        json_data = super(DataDocument, self).data()
...
class ErrorDocument(JSONDocument):
    ...
    def __init__(self, errors=None, included=None, links=None):
        super(ErrorDocument, self).__init__(included, links)
    ...
    def data(self):
        json_data = super(ErrorDocument, self).data()
